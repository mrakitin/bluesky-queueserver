...
Usage::
    ...
    pixi run python -m bluesky_queueserver.mcp_server.chat
    ...
    QSERVER_USER_GROUP=primary pixi run python -m bluesky_queueserver.mcp_server.chat
...
def main():
    ...
    from bluesky_queueserver.mcp_server.server import create_server
